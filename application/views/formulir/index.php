    ...
    <div id="content">
        ...
        <div class="container-fluid">
            ...
            <div class="d-sm-flex align-items-center justify-content-between mb-4">
                <h1 class="h3 mb-0 text-gray-800"><i class="fas fa-fw fa-edit"></i> Isi Data Formulir</h1>
                ...
                <form action="<?php echo base_url('Formulir/update/'.$user['id_alternatif']); ?>"
                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="form-group col-md-6" row="3">
                                <label class="font-weight-bold">Alamat Lengkap</label>
                                <textarea class="form-control" type="text-area" name="alamat" required
                                    class="form-control" row="6"></textarea>
                            </div>
